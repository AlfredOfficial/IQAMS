...
@endphp
<x-portal-document :title="$title" body-class="bg-[#f5f7f7] font-sans text-slate-800 antialiased" :include-qr-code="true" alpine-data="{ sidebarOpen: false, userMenuOpen: false }">
