<div class="relative inline-flex"
     x-data="{
         ...
         positionMenu() {
             ...
             const visibleHeight = Math.max(0, Math.min(menuHeight, opensUpward ? spaceAbove : spaceBelow));
             const preferredTop = opensUpward ? triggerRect.top - gap - visibleHeight : triggerRect.bottom + gap;
             ...
             this.right = Math.min(Math.max(window.innerWidth - triggerRect.right, viewportPadding), maxRight);
         },
     }"
