<x-student-layout title="Account Settings">
    <div class="mb-6"><h2 class="font-display text-2xl font-semibold text-slate-900">Account settings</h2><p class="mt-1 text-sm text-slate-500">Manage your profile photo, password, and account session.</p></div>
    <div class="grid gap-6 lg:grid-cols-2">
        <section id="photo" class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/70" x-data="{ preview: @js(Auth::user()->avatar_url), objectUrl: null }">
            <h3 class="font-display font-semibold">Profile photo</h3><p class="mt-1 text-sm text-slate-500">JPG, PNG, or WebP up to 2 MB.</p>
        ...
        <section class="rounded-2xl bg-white p-6 shadow-sm ring-1 ring-slate-200/70">
            <h3 class="font-display font-semibold">Change password</h3><p class="mt-1 text-sm text-slate-500">Confirm your current password before choosing a new one.</p>
