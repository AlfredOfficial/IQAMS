<div class="mx-auto max-w-7xl space-y-6">
    ...
    <form method="POST" action="{{ route($storeRoute ?? 'leave-requests.store') }}" enctype="multipart/form-data" class="grid gap-5 rounded-2xl bg-white p-5 shadow-sm ring-1 ring-slate-200/70 sm:grid-cols-2 sm:p-6">
        @csrf
